-- COURSES
INSERT INTO COURSE (CourseCode, CourseName, CourseUnits) VALUES
('CS101', 'Course Name', 3),
('CS102', 'Course Name', 3),
('CS201', 'Course Name', 3),
('CS202', 'Course Name', 3),
...
('IT801', 'Course Name', 3),
('IT802', 'Course Name', 3),
('GEN101', 'Communication Skills', 3);

-- COURSE_TERM (Mapping courses to terms)
INSERT INTO COURSE_TERM (CourseCode, TermID) VALUES
('CS101', 'CS1'),
('CS102', 'CS1'),
('CS201', 'CS2'),
('CS202', 'CS2'),
